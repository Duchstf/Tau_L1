...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_default_t, 2000>(w2, "w2.txt");
        nnet::load_weights_from_txt<model_default_t, 25>(b2, "b2.txt");
        nnet::load_weights_from_txt<model_default_t, 250>(w4, "w4.txt");
        nnet::load_weights_from_txt<model_default_t, 10>(b4, "b4.txt");
        nnet::load_weights_from_txt<model_default_t, 100>(w6, "w6.txt");
        nnet::load_weights_from_txt<model_default_t, 10>(b6, "b6.txt");
        nnet::load_weights_from_txt<model_default_t, 10>(w8, "w8.txt");
